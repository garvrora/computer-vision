...
for contour in red_filtered_contours:
    ...
    cv.putText(img,f'RED FRUIT {red_count}',(x-20,y-20),cv.FONT_HERSHEY_TRIPLEX,0.6,(0,0,255),thickness = 2)

cv.imshow('detected_fruits', img)
cv.imwrite('detected_fruits_2.jpg', img)
