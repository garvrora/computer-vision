...
This has been done using a global Earth model for representation purposes. For more accuracy, it can also be replicated on a 2D map of Earth. Even on a globe model, the blast wave can be modified to follow the Earth's curvature by also taking the latitude and longitudes into consideration.
